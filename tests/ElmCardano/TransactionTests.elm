        ...
        [ describe "Transaction.toCbor"
            [ test "basic encode" <|
                \_ ->
                    let
                        transactionId =
                            Hex.fromString "9D7F457DD62D2062565F794E42F9ECA458D9CFBCA73A7893899D16F02C2B36B6"
                    in
                    Tx.new
                        ...
                        |> Tx.requiredSigner (Hex.fromString "dd4edd90a2299da2525053c5e18e7c72625f7cf926f5731139d93bae")
                        ...
                        |> Tx.referenceInput { transactionId = Hex.fromString "517b059959fc8ee584689f71cf1d9bb94fc36802aec0faa7fd96182c0ab090c4", outputIndex = 0 }
                        |> Tx.complete
